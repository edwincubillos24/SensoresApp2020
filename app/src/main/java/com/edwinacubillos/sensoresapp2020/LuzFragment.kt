...
import kotlinx.android.synthetic.main.fragment_luz.view.*
import kotlinx.android.synthetic.main.fragment_luz.view.info
import kotlinx.android.synthetic.main.fragment_luz.view.tv_salida
...
class LuzFragment : Fragment(), SensorEventListener {
    ...
    override fun onCreateView(
        ...
        val listSensores: List<Sensor> = sensorManager.getSensorList(Sensor.TYPE_LIGHT)
        ...
        if (listSensores.isNotEmpty()) {
            ...
            rootView.info.text = "No tiene sensor de Luz"
        }
    ...
    override fun onSensorChanged(event: SensorEvent?) {
        rootView.tv_salida.text = "Intensidad de Luz: "+event!!.values[0]
    }
}
